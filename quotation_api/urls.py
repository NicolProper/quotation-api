...
urlpatterns = [
    ...
    # path('usuarios/match/<str:dni>/', match_user_by_DNI, name='match_user_by_DNI'),
    path('cotizacion/crear_cotizacion/', crear_cotizacion, name="crear_cotizacion"),
    ...
    path('', include("financiamiento.urls")),
